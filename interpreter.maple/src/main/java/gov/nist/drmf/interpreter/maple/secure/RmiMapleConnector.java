 ...
 */
public class RmiMapleConnector implements NativeComputerAlgebraInterfaceBuilder<Algebraic> {
    private static final Logger LOG = LogManager.getLogger(RmiMapleConnector.class.getName());
