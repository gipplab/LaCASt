...
public class GenericReplacementToolTests {
    ...
    void constantReplaceTest() throws ParseException {
        ...
        GenericReplacementTool replacementTool = new GenericReplacementTool();
        ppte = replacementTool.getSemanticallyEnhancedExpression(ppte);
    ...
    void imReplacementTest() throws ParseException {
        ...
        GenericConstantReplacer replacementTool = new GenericConstantReplacer();
        ppte = replacementTool.fixConstants(ppte);
