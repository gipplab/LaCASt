...
import gov.nist.drmf.interpreter.pom.data.CASFunctionMetaInfo;
import gov.nist.drmf.interpreter.pom.data.DLMFTranslationHeaders;
import gov.nist.drmf.interpreter.pom.data.FunctionInfoHolder;
